    ...
    !(function(t, n) {
            ...
            var t = [
              ...
              i = {
                ...
                then: function(e, r, i) {
                  ...
                  return C.Deferred(function(n) {
                    t[0][3].add(s(0, n, m(i) ? i : I, n.notifyWith)),
                      t[1][3].add(s(0, n, m(e) ? e : I)),
                      t[2][3].add(s(0, n, m(r) ? r : F));
                  }).promise();
                },
                promise: function(e) {
        ...
        C.extend({
          ...
          ready: function(e) {
            (!0 === e ? --C.readyWait : C.isReady) ||
              ((C.isReady = !0),
              (!0 !== e && --C.readyWait > 0) || z.resolveWith(s, [C]));
          }
        }),
        (C.ready.then = z.then),
      ...
      function Se(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; (o = p[d++]); )
          if (r && C.inArray(o, r) > -1) i && i.push(o);
            ...
            ((l = ae(o)), (s = xe(f.appendChild(o), "script")), l && be(s), n)
          )
      ...
      function Le(e, t, n) {
        n
          ...
          : void 0 === J.get(e, t) && C.event.add(e, t, Ne);
      }
      (C.event = {
        global: {},
        ...
        dispatch: function(e) {
          ...
          if (
            ...
            for (
              s = C.event.handlers.call(this, a, l), t = 0;
      ...
      function Fe(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            J.hasData(e) &&
            ((o = J.access(e)), (s = J.set(t, o)), (l = o.events))
          )
            for (i in (delete s.handle, (s.events = {}), l))
              for (n = 0, r = l[i].length; n < r; n++)
                C.event.add(t, i, l[i][n]);
          Z.hasData(e) &&
            ((a = Z.access(e)), (u = C.extend({}, a)), Z.set(t, u));
        }
      }
      function Be(e, t) {
        var n = t.nodeName.toLowerCase();
      ...
      function $e(e, t, n, r) {
        ...
        if (
          ...
          if (a)
            for (
              c = s[s.length - 1].ownerDocument, C.map(s, Ie), f = 0;
              f < a;
              f++
            )
              (u = s[f]),
      ...
      function ot(e, t, n) {
        ...
        return (
          ((!v.boxSizingReliable() && i) ||
            ...
            (o = a in e) && (s = e[a])),
          (s = parseFloat(s) || 0) +
            it(e, t, n || (i ? "border" : "content"), o, r, s) +
            "px"
        );
      }
      ...
      C.extend(C.event, {
        trigger: function(e, t, r, i) {
          ...
          if (
            ...
            3 !== r.nodeType &&
              8 !== r.nodeType &&
              !St.test(y + C.event.triggered) &&
              (y.indexOf(".") > -1 &&
                ((v = y.split(".")), (y = v.shift()), v.sort()),
              (c = y.indexOf(":") < 0 && "on" + y),
              ((e = e[C.expando]
                ? e
                : new C.Event(y, "object" == typeof e && e)).isTrigger = i
                ? 2
                : 3),
              (e.namespace = v.join(".")),
            ...
            if (!i && !p.noBubble && !x(r)) {
              for (
                l = p.delegateType || y, St.test(l + y) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                g.push(a), (u = a);
            ...
            return (
              ...
              i ||
                ...
                (c &&
                  ...
                  ((u = r[c]) && (r[c] = null),
                  (C.event.triggered = y),
                  e.isPropagationStopped() && d.addEventListener(y, At),
                  r[y](),
                  e.isPropagationStopped() && d.removeEventListener(y, At),
        ...
        C.extend({
          ...
          ajax: function(e, t) {
            ...
            if (
              ...
              if (((S.readyState = 1), f && y.trigger("ajaxSend", [S, h]), c))
                return S;
              h.async &&
                h.timeout > 0 &&
            ...
            function A(e, t, s, a) {
              ...
              c ||
                ...
                (S.status = e),
                (S.statusText = (t || T) + ""),
                l ? v.resolveWith(g, [p, T, S]) : v.rejectWith(g, [S, T, d]),
                S.statusCode(x),
                (x = void 0),
                f &&
                  y.trigger(l ? "ajaxSuccess" : "ajaxError", [S, h, l ? p : d]),
                m.fireWith(g, [S, T]),
                f &&
                  (y.trigger("ajaxComplete", [S, h]),
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function(e, t) {
          C.cssHooks[t] = Qe(v.pixelPosition, function(e, n) {
            if (n)
              return (n = Ve(e, t)), _e.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (C.noConflict = function(e) {
          return (
            n.$ === C && (n.$ = Zt), e && n.jQuery === C && (n.jQuery = Jt), C
          );
        }),
        i || (n.jQuery = n.$ = C),
        C
      ...
      (function() {
        ...
        function o(e) {
          (this.element = e),
            ...
            (t += 1),
            r.windowContext ||
              ((r.windowContext = !0), (r.windowContext = new o(window))),
        ...
        (r.prototype.innerHeight = function() {
          ...
          (r.prototype.off = function(e, t) {
            ...
            if (o && this.handlers[o] && i)
              ...
              for (var u in this.handlers[o]) n(s, this.handlers[o][u], t);
              this.handlers[o] = {};
            }
          }),
          ...
          (r.extend = function() {
            ...
            for (var n = 1, r = e.length; n < r; n++) t(e[0], e[n]);
            return e[0];
          }),
          ...
          e.adapters.push({ name: "noframework", Adapter: r }),
          (e.Adapter = r);
      })();
  },
  function(e, t, n) {
    ...
    new (class {
      constructor() {
        (this.siteNav = i()("nav")),
          (this.navTriggerElement = i()(".features-section--js")),
      ...
      createHeaderWaypoint() {
        ...
        new Waypoint({
          ...
          handler: function(t) {
            "down" == t
              ? e.siteNav.addClass("sticky")
              : e.siteNav.removeClass("sticky");
          },
          offset: "60px;"
        });
      }
